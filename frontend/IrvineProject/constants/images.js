...
const chips = require("../assets/images/chips.png");
const logo = require("../assets/images/logo.png"); //yes
const NewsPic1 = require("../assets/images/news1.png")
const red= require("../assets/images/red.png");
const NewsDetail = require("../assets/images/newsDetail.png");
...
export default {
    ...
    tomato_pasta,
    card,
 chips, logo, NewsPic1, red, NewsDetail, fund 
}